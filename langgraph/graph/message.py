...
def _add_messages_wrapper(func: Callable) -> Callable[[Messages, Messages], Messages]:
    def _add_messages(
        ...
        if left is not None and right is not None:
            ...
            # String formatting moved out for minor efficiency
    ...
    _add_messages.__doc__ = func.__doc__  # Assign docstring once at definition time
    return _add_messages  # type: ignore[return-value]
